#ifdef _GC_
//via https://github.com/susam/pcface
const unsigned char char8x8[] = {
...
GCFONT font8x8 = {&char8x8[0], 8, 8, 0, sizeof(char8x8), 0};
#else
extern GCFONT font8x8;
#endif
#define GetFont8x8() &font8x8
#ifndef _DEFAULTFONT_
#define _DEFAULTFONT_
#define GetDefaultFont() GetFont8x8()
#endif