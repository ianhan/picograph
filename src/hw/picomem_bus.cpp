...
#elif PICOMEM_BOARD_PICOMEM_M2
#include "isa_iomem_m2.pio.h"
#elif PICOMEM_BOARD_PICOMEM_LP
#include "isa_iomem_noaen.pio.h"
#elif PICOMEM_BOARD_PICOMEM_15
#include "isa_iomem_m2_v15.pio.h"
#else
#error "Unsupported PICOMEM_BOARD"
#endif
...
void picomem_bus_init() {
    ...
    if (claimed != kIsaBusSm) {
        printf("picomem: expected ISA SM %u, got %u\n", kIsaBusSm, claimed);
    }
